            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // TFG: Aquí llamamos a tu widget encapsulado que contiene
                  // el título, el botón de abrir la gráfica, y las tarjetas de precio.
                  MarketDataWidget(setNum: widget.legoSet.setNum),
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Añadir a deseados'),
                      onPressed: () async {
                        final double priceToSave = 0.0; // Temporal
