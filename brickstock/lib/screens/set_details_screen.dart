...
class _SetDetailsScreenState extends State<SetDetailsScreen> {
  ...
  // TFG: Variables para controlar el mercado
  Future<Map<String, dynamic>?>? _marketDataFuture;
  double _currentMarketValue = 0.0; // Aquí guardaremos el precio para los botones
  ...
  void initState() {
    ...
    // TFG: Hacemos la petición a la API al abrir la pantalla
    _marketDataFuture = ApiService().getSetMarketData(widget.legoSet.setNum);
    
    // Cuando la API responda, extraemos el valor de mercado en silencio para los botones
    _marketDataFuture?.then((data) {
      if (mounted && data != null) {
        setState(() {
          // Parseamos el valor que viene de Node.js
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // TFG: Pasamos la petición ya iniciada al widget para que no la repita
                  MarketDataWidget(
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      onPressed: () async {
                        // TFG: AHORA USAMOS EL PRECIO DE MERCADO REAL
