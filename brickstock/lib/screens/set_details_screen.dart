    ...
    _marketDataFuture?.then((data) {
      if (mounted && data != null) {
        setState(() {
          ...
          _estimatedRetailPrice = (data['estimatedRetailPrice'] as num)
              .toDouble();
        });
      }
    });
            ...
            child: Column(
              ...
              children: [
                ...
                MarketDataWidget(
                  ...
                  marketDataFuture: _marketDataFuture!,
                  showButton:
                      false, // Ocultamos el botón porque la gráfica ya está fuera
                ),
                const SizedBox(height: 30),
                _buildWishlistButton(),
                const SizedBox(height: 80),
          ...
          children: [
            ...
            InkWell(
              onTap: () async {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Buscando manuales...'),
                    duration: Duration(seconds: 1),
                  ),
                );
                final urls = await ApiService().getSetInstructions(
                  widget.legoSet.setNum,
                );
                ...
                if (urls.isNotEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('No hay manuales en PDF disponibles.'),
                      backgroundColor: Colors.orange,
                    ),
                  );
                }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FutureBuilder<String>(
                      ...
                      builder: (context, snapshot) {
                        final themeName = snapshot.hasData
                            ? snapshot.data!
                            : 'Cargando...';
                ...
                child: Column(
                  ...
                  children: [
                    _buildDetailItem(
                      ...
                      'Año',
                      widget.legoSet.year.toString(),
                    ),
                    const SizedBox(height: 15),
                    _buildDetailItem(
                      Icons.extension,
                      'Piezas',
                      widget.legoSet.numParts.toString(),
                    ),
                  ],
                ),
              ),
        ...
        child: Row(
          ...
          children: [
            FloatingActionButton(
              ...
              onPressed: () =>
                  _showMinifiguresBottomSheet(context, widget.legoSet.setNum),
                          ...
                          actions: [
                            TextButton(
                              onPressed: () => Navigator.pop(
                                ctx,
                              ), // Cierra el modal y permite que el bucle continúe
                              child: const Text(
                                '¡Genial!',
