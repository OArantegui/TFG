...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color(0xFF121212),
      body: SingleChildScrollView(
        // TFG: Dejamos esto vacío para que el espaciador interno haga el trabajo correctamente
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            Container(
            ...
            // TFG: EL SALVAVIDAS
            // Forzamos un bloque gigante al final para que la barra flotante (extendBody) NUNCA tape el botón de guardar.
